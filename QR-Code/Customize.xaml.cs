...
namespace QR_Code
{
    ...
    public sealed partial class Customize : Page
    {
        ...
        private async void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            String filename = "QR_";
            if (SplitPage1.qselect == 0) filename += "FreeText";
            else if (SplitPage1.qselect == 1) filename += "URL";
            else if (SplitPage1.qselect == 2) filename += "Contact";
            else if (SplitPage1.qselect == 3) filename += "Phone";
            else if (SplitPage1.qselect == 4) filename += "SMS";
