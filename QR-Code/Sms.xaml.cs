...
namespace QR_Code
{
    ...
    public sealed partial class Sms : Page
    {
        ...
        void UpdateImage()
        {
            ...
            wide310x150Content.TextCaptionWrap.Text = "SMS";
        ...
        private void Submit_Click(object sender, RoutedEventArgs e)
        {
            ...
            String url = "http://chart.apis.google.com/chart?chs=300x300&cht=qr&chld=|1&chl=SMSTO%3A"+PhoneNumber.Text+"%3A"+ Message.Text;
            ImageUrl = url;
            UpdateImage();
