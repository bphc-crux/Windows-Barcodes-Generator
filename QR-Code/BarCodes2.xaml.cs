    ...
    public sealed partial class BarCodes2 : Page
    {
        ...
        void itemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            switch (itemListView.SelectedIndex)
            {
                ...
                case 0:
                    itemTitle.Text = "AZTEC";
                    FreeTitle.Text = "AZTEC";
                    aztecText.Visibility = Visibility.Visible;
                    dataText.Visibility = Visibility.Collapsed;
                    break;
                case 1:
                    itemTitle.Text = "DATA_MATRIX";
                    FreeTitle.Text = "DATA_MATRIX";
                    dataText.Visibility = Visibility.Visible;
                    aztecText.Visibility = Visibility.Collapsed;
                    break;
            }
        ...
        {
            if (BarCodes2.str.Equals("")) { Save.IsEnabled = false; Customize.IsEnabled = false; return; } string str = "";
            switch (itemListView.SelectedIndex)
            {
                case 0:
                    str = "AZTEC";
