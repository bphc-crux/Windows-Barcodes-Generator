...
namespace QR_Code
{
    ...
    public sealed partial class URL : Page
    {
        ...
        void UpdateImage()
        {
            ...
            wide310x150Content.TextCaptionWrap.Text = "Website";
        ...
        {
            if (Freetext.Text.Equals("")) { ShowPopupAnimationClicked("Enter a valid URL to continue."); return; }
            String url = "http://chart.apis.google.com/chart?chs=300x300&cht=qr&chld=|1&chl=http%3A%2F%2F" + Freetext.Text;
            ImageUrl = url;
            UpdateImage();
