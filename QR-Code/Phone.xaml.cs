...
namespace QR_Code
{
    ...
    public sealed partial class Phone : Page
    {
        ...
        void UpdateImage()
        {
            ...
            wide310x150Content.TextCaptionWrap.Text = "Phone Number";
        ...
        {
            try { long n = Convert.ToInt64(Freetext.Text); }
            catch (Exception) { ShowPopupAnimationClicked("Enter a valid Phone-Number to continue."); return; }
            String url = "http://chart.apis.google.com/chart?chs=300x300&cht=qr&chld=|1&chl=tel%3A" + Freetext.Text;
            ImageUrl = url;
            UpdateImage();
